...
final_output = "/data/Wilson_Lab/projects/placentas_VW_ASE/06_males/"
...
for placenta in config["dna_rna_males"]:
    for quadrant in quadrants:
        ...
        for chrom in chromosomes:
            ...
            # BAM file
            bam = bam_dir+rna_sample_id+"_HISAT_pair_trim_sort_mkdup_rdgrp_XY.bam"

            # Output file that combines vcf, bam, and chromosome
            outdir = final_output+"HISAT/"+quadrant+"/chr"+chrom+"/"
            print(f"mkdir -p {outdir}")
            outputfile = outdir+placenta+"_"+quadrant+"_chr"+chrom+"_males.tsv"
