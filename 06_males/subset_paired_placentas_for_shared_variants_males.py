...
base = "/data/Wilson_Lab/projects/placentas_VW_ASE/06_males/allele_balance_tables/"
...
for placenta in placentas:
    ...
    out_dir = "/data/Wilson_Lab/projects/placentas_VW_ASE/06_males/paired_placentas_shared_variants/"
