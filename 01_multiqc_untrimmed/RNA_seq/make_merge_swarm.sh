...
for d in Sample_*; do
    sample=$(basename "$d")
    r1_out="/data/Wilson_Lab/projects/placentas_VW_ASE/01_multiqc_untrimmed/RNA_seq/merged_fastqs/${sample}_quad2_R1_merged.fastq.gz"
    r2_out="/data/Wilson_Lab/projects/placentas_VW_ASE/01_multiqc_untrimmed/RNA_seq/merged_fastqs/${sample}_quad2_R2_merged.fastq.gz"
...
done >> /data/Wilson_Lab/projects/placentas_VW_ASE/01_multiqc_untrimmed/RNA_seq/merge_fastqs.swarm

cd /data/Wilson_Lab/placenta/valleywise_raw_data/valleywise_placenta_3samples/quadrant_3
for d in Sample_*; do
    sample=$(basename "$d")
    r1_out="/data/Wilson_Lab/projects/placentas_VW_ASE/01_multiqc_untrimmed/RNA_seq/merged_fastqs/${sample}_quad3_R1_merged.fastq.gz"
    r2_out="/data/Wilson_Lab/projects/placentas_VW_ASE/01_multiqc_untrimmed/RNA_seq/merged_fastqs/${sample}_quad3_R2_merged.fastq.gz"
...
for d in Sample_*; do
    sample=$(basename "$d")
    r1_out="/data/Wilson_Lab/projects/placentas_VW_ASE/01_multiqc_untrimmed/RNA_seq/merged_fastqs/${sample}_quad4_R1_merged.fastq.gz"
    r2_out="/data/Wilson_Lab/projects/placentas_VW_ASE/01_multiqc_untrimmed/RNA_seq/merged_fastqs/${sample}_quad4_R2_merged.fastq.gz"
