...
```bash
/data/Wilson_Lab/projects/placentas_VW_ASE/00_multiqc_untrimmed/RNA_seq/merge_fastqs.swarm
/data/Wilson_Lab/projects/placentas_VW_ASE/00_multiqc_untrimmed/RNA_seq/merged_fastqs/
```
- FASTQ list:
```bash
...
- FastQC swarm file:
```bash
/data/Wilson_Lab/projects/placentas_VW_ASE/00_multiqc_untrimmed/RNA_seq/fastqc.swarm
```
- FastQC output directory:
```bash
/data/Wilson_Lab/projects/placentas_VW_ASE/00_multiqc_untrimmed/RNA_seq/fastqc_results/
```
