...
config_json = open("asereadcounterQ3_config.json")
...
output_directory_rna = "/data/Wilson_Lab/projects/placenta_multiomics/valleywise_3samples/processed_bams_HG38/rna/"
...
for key in dna_rna_hash["dna_rna_females"]:
    for item in dna_rna_hash["dna_rna_females"][key]:
        for chrom in chromosomes:
            ...
            #bam file
            bam = output_directory_rna+item+"_HISAT_pair_trim_sort_mkdup_rdgrp_XX.bam"

            #output file that combines vcf, bam, and chromosome
            outputfile = final_output+"HISAT_allQs/Q3/chr"+chrom+"/"+item+"_chr"+chrom+"_females.tsv"
