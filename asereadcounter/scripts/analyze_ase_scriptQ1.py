    ...
    for item in dna_rna_hash["dna_rna_females"][key]:
        for chrom in chromosomes:
           # asereadcounter output
            outputfile = output_directory_dna+"HISAT/Q1/chr"+chrom+"/"+item+"_chr"+chrom+"_females.tsv"
            analysisfile = output_directory_dna+"analyze_ase_results/allele_balance_tables/Q1/chr"+chrom+"/"+key+"_"+item+"_chr"+chrom+"_allele_balance.tsv"
